  ...
  return (
    <div className='flex justify-center items-center w-full h-16 px-4 z-10 fixed bg-gray-100 dark:bg-slate-900 bg-opacity-80 border-b border-gray-300 dark:border-gray-700'>
      ...
      <nav className='hidden md:flex pr-16 capitalize items-center'>
        ...
        <button onClick={toggleTheme} className="flex justify-center items-center dark:bg-purple-600 dark:hover:bg-purple-700 bg-cyan-700 hover:bg-cyan-800 transition-color duration-200 ease-in-out mx-6 px-2 py-2 rounded-lg font-semibold">
