  ...
  return (
    <div name='about' className='w-full h-screen'>
      <div className='max-w-screen-lg p-4 pt-44 mx-auto flex flex-col justify-center w-full'>
        ...
        <p className='text-xl'>
          As a high-school tutor and former e-sports player, I like to tackle challenging projects that allow me to leverage my ability to learn, adapt, and thrive in a team-oriented environment. I am currently bolstering my professional skills in a technical business analysis rotation - applying concepts that I've absorbed throughout my academic journey to real-world situations.
        </p>
      </div>
